...
export default function EstatisticasScreen() {
  ...
  // Função para contar ocorrências de um campo em uma lista
  ...
  // Encontrar chave com maior valor no objeto
  ...
  // Obter número da semana ISO do ano
  ...
  // Filtrar agendamentos considerando só a parte da data (ignorando hora e timezone)
  const agendamentosDia = agendamentos.filter(a => {
    const dataAg = a.data.split('T')[0];
    return dataAg === diaHojeStr;
  });
  ...
  // Somar os valores reais do campo 'valor' para receita
  ...
  // Atendimentos por Dia da Semana (para modal)
